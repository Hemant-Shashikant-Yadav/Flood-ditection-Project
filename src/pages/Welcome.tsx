    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-20 min-h-screen flex items-center justify-center">
        ...
        >
          ...
          >
            <Droplets size={80} className="text-blue-400 drop-shadow-[0_0_15px_rgba(59,130,246,0.5)]" />
          </motion.div>
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <p className="text-2xl text-blue-200">Early Warning System for Flood Detection</p>
            <p className="text-lg text-gray-300">Protecting communities through real-time monitoring</p>
          </motion.div>
        </motion.div>
      </div>
    </div>
